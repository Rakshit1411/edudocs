...
public class MyItemRecyclerViewAdapter extends RecyclerView.Adapter<MyItemRecyclerViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.noti.setImageDrawable(drawable);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            noti = (ImageView)view.findViewById(R.id.imageView);
            ...
            TextDrawable.IBuilder builder = TextDrawable.builder().beginConfig()
                    ...
                    .endConfig()
                    .round();
            //get first dialog from Chat Dialog Title for create Chat Dialog Image
            drawable = builder.build(mIdView.getText().toString(),randomColor);
