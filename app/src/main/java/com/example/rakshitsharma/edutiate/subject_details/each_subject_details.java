...
public class each_subject_details extends AppCompatActivity implements overview.OnFragmentInteractionListener,subject_content.OnFragmentInteractionListener {
    ...
    private BottomNavigationView.OnNavigationItemSelectedListener mOnNavigationItemSelectedListener
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                ...
                {
                    FragmentTransaction xfragmentTransaction = mFragmentManager.beginTransaction();
                    xfragmentTransaction.replace(R.id.framie,new subject_content()).commit();
                    return true;
                }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("My Subject");
